  ...
  return (
    ...
    >
      <div className="rounded-[40px]  bg-chair2 md:bg-chair relative max-w-[1090px] bg-center bg-cover bg-no-repeat h-screen w-full">
          ...
          <div className="   flex space-y-2 flex-col mx-3 m-auto md:flex-row justify-around items-start  lg:items-center ">
            ...
            <div className=" w-full md:w-auto   ">
              <div className=" flex flex-row-reverse md:flex-col gap-[6px] max-w-full items-end md:items-center  justify-between md:justify-center">
                <div className=" overflow-x-hidden   backdrop-blur-[32px]  px-3 pt-4 pb-2  rounded-[32px] max-w-[251px] text-center  flex flex-col items-center flex-1 w-full  justify-center gap-[15px]">
                  <div className=" rounded-full overflow-x-hidden   text-primary font-rosca gap-1 flex flex-row items-center justify-start  ">
                    <Image
                      ...
                      height={16}
                    />
                    <h2 className="text-third md:text-inherit">
        ...
        <div className=" absolute bottom-1 md:hidden left-2  backdrop-blur-[32px]  px-2 py-3   rounded-[32px] w-[27%] text-center  flex flex-col items-center   justify-center ">
          <div className=" flex flex-col items-center  justify-center gap-1 text-primary  font-rosca">
            <div className=" flex flex-row  justify-center items-center gap-1">
              <h1 className=" font-extrabold text-[24px]">1.2k</h1>
              <h2 className=" font-opensans   text-[20px] font-medium">
                Projects
              </h2>
            </div>
      ...
      <div className="flex flex-col relative h-[35vh] md:h-[45vh] lg:h-screen w-full flex-wrap  lg:max-w-[260px]  gap-3">
        <div className=" flex flex-row lg:flex-col gap-4 space-y-4">
          <div className=" space-y-3 flex flex-col max-w-[193px]  md:max-w-[260px]  rounded-[40px] w-full h-[173px] md:h-full">
            ...
            />
            <div id="icons" className="  flex flex-row  justify-evenly ">
              <Linkedin className="size-[24px]" />
              <Instagram className="size-[24px]" />
              <Twitter className="size-[24px]" />
              <h2 className="  flex flex-row  underline underline-offset-2 ">
                Resume
                <ArrowUpRight className="size-[24px]  stroke-1 font-light" />
              </h2>
            </div>
          </div>
          ...
          <div className=" flex flex-col justify-between space-y-4   ">
            <div className="lg:space-y-4 text-balance ">
              <h2 className="text-[24px] text-balance font-medium">
